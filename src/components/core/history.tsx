...
export const History = ({ className }: HistoryProps): JSX.Element => {
    ...
    const copyLink = (secret: string) => {
        ...
        // toast.success(`Push link copied`);
    };
    ...
    return (
        <>
            ...
            <Slide direction="right" in={isOpen} style={{ zIndex: 2 }}>
                {/* @ts-ignore */}
                <Container ref={ref}>
                    <Stack px={2} mb={5} direction="row" justify="space-between" align="baseline">
