    ...
    return (
        <Tooltip label="Switch color theme">
            <IconButton
                ...
                size="md"
                icon={colorMode === 'light' ? <MoonIcon color="gray.500" /> : <SunIcon />}
            />
        </Tooltip>
    );
}
                        ...
                        <Menu>
                            <MenuButton as="div">
                                <Stack direction="row">
                                    ...
                                    <ChevronDownIcon width="24px" height="24px" color="gray.500" />
                                </Stack>
                            </MenuButton>
                            <MenuList>
                                <Link href={'/'}>
                                ...
                                <a href={'https://twitter.com/solpushcom'} target="_blank" rel="noreferrer noopener">
                                    <MenuItem>
                                        {/* Twitter <Icon ml={2} as={FaTwitter} /> */}
                                    </MenuItem>
                                </a>
                                <a href={'https://t.me/solanapush'} target="_blank" rel="noreferrer noopener">
                                    <MenuItem>
